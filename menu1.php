...
<html>
  ...
  <body>
    ...
    <div id="preloader">
      <div id="status">
        <img class="svg" src="assets/img/logo-big.svg" width="133" height="120" alt="Eattie"/>
        <img class="png" src="assets/img/logo-big.png" width="133" height="120" alt="Eattie"/>
        <div id="fountainG">
        ...
        <nav class="navbar" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="navi-collapse">
              <ul class="nav navbar-nav nav-left">
                ...
                <li ><a class="scroll-up" href="#home">home</a></li>
              </ul>
              <ul class="nav navbar-nav nav-right">
                <li class="active"><a href="menu1.html">Menu</a></li>
    ...
    <section class="block menu1">
      <div class="fsbg">
        ...
        <div class="visible" style="background-image: url(assets/img/menu/default.jpg)"></div><!--Generic Default Image not connected with any recipe-->
        <div id="m_1" style="background: url(assets/img/menu/m_1.jpg)"></div>
        <div id="m_2" style="background: url(assets/img/menu/m_2.jpg)"></div>
        <div id="m_3" style="background: url(assets/img/menu/m_3.jpg)"></div>
        <div id="m_4" style="background: url(assets/img/menu/m_4.jpg)"></div>
        <div id="m_5" style="background: url(assets/img/menu/m_5.jpg)"></div>
        <div id="m_6" style="background: url(assets/img/menu/m_6.jpg)"></div>
      </div>
    ...
    <!--Javascript (jQuery)-->
		...
		<script src="assets/js/scripts-secondary.js"></script>
