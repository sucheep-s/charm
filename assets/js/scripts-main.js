...
var geocoder;
var map;
var query = '960 Schillinger Rd S, Mobile, AL, United States';
function initialize() {
	geocoder = new google.maps.Geocoder();
	var latlng = new google.maps.LatLng(30.66997, -88.22600);
...
function codeAddress() {
	var image = 'assets/img/charm-marker.png';
  var address = query;
